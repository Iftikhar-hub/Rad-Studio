...
const GetRADStudio = () => {
    return (
        ...
        max-[744px]:w-[744px] max-[768px]:mt-[400px]">
            ...
            max-[1440px]:h-[722px]
            max-[744px]:h-[724px] max-[744px]:top-[-570px] max-[744px]:left-[-410px]" src={leftVector} alt="leftVector" />

            <img className="right-vector w-[811px] h-[897px] absolute bottom-[-7px] right-[-68px]
            max-[1440px]:h-[672px]
            max-[744px]:h-[673px] max-[744px]:bottom-[-100px] max-[744px]:right-[-450px]" src={rightVector} alt="rightVector" />
                ...
                <div className="GRC-logos w-[1038px] flex flex-col gap-[32px] justify-center items-center opacity-100 
                 max-[1440px]:w-[598px] ">
                    ...
                    <div className="RGC-logo2 justify-center items-center h-[64px] flex flex-row gap-[32px]">
                        ...
                        max-[744px]:w-[56px] max-[744px]:h-[56px]" src={RADs} alt="RADs" />
                        <img className="radsImage1 w-[64px] h-[64px]
                        max-[744px]:w-[56px] max-[744px]:h-[56px]" src={rrr} alt="rrr" />
                        <img className="radsImage1 w-[64px] h-[64px]
                        max-[744px]:w-[56px] max-[744px]:h-[56px]" src={cplus} alt="cplus" />
                        <img className="radsImage1 w-[64px] h-[64px]
                        max-[744px]:w-[56px] max-[744px]:h-[56px]" src={shaheen} alt="shaheen" />
                        <img className="radsImage1 w-[64px] h-[64px]
                        max-[744px]:w-[56px] max-[744px]:h-[56px]" src={wings} alt="wings" />
