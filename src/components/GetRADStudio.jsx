            ...
            <div className="GetRadContent absolute w-[1038px] h-[302px] opacity-100 top-[128px] left-[280px]  
              ...
              max-[1440px]:w-[598px] max-[1440px]:left-[390px] ">
                ...
                max-[1440px]:w-[598px] ">
                    ...
                    <div className="RGC-logo2 justify-center items-center w-[448px] h-[64px] flex flex-row gap-[32px]">
                ...
                <div className="GRC-btns w-[160px] h-[48px] opacity-100 flex gap-[8px] rounded-[10px] 
