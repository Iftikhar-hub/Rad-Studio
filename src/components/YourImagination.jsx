...
const YourImagination = () => {
    return (
        <section className="Your-Imagination flex flex-col w-full max-w-[1536px]
         ...
         max-[375px]:w-[343px] max-[375px]:h-auto max-[375px]:mt-[80px]">
            ...
            <div className="Imagination-Container flex flex-col items-center w-[1536px] h-[845px]
              max-[1440px]:w-[1280px] max-[1440px]:h-[969px] max-[1440px]:gap-[32px]
               ...
               max-[375px]:w-[343px] max-[375px]:h-auto">
                ...
                <div className="ImaginationHero flex justify-center items-center w-[1536px] h-[740px]   
                  ...
                  max-[375px]:w-[343px]">
                    ...
                    max-[375px]:w-[343px] max-[375px]:h-[240px] max-[375px]:py-[48px] max-[375px]:px-[32px]">
                        <img className="IgnitPic w-[482px] h-[394px] max-[375px]:w-[247px] max-[375px]:h-[188px]" src={IgnitPicture} alt="IgnitPicture"/>
                    ...
                    max-[375px]:w-[343px]">
                        ...
                        max-[375px]:w-[295px] max-[375px]:h-auto">
                            ...
                            <div className="ipTag-1 list-disc pl-5 flex flex-col w-[589px] h-[484px] gap-[24px]
                            max-[1440px]:gap-[24px]
                            max-[375px]:w-[295px] max-[375px]:h-auto">

                                <p className="ipTag-1-1 list-item  opacity-100 font-archivo font-normal text-[16px] leading-[150%] tracking-[0px] text-[#171717]
                               ">
                        ...
                        max-[744px]:ml-[21px]
                        max-[375px]:max-w-[295px] max-[375px]:w-full">
