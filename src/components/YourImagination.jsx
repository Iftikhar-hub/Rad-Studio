      ...
      >
        ...
        >
          <div
           ...
           >
            <a
              className="I-Ds bg-[#262626] text-[white] flex flex-row max-w-[217.14px] h-[57px] py-[14px] px-[24px] rounded-[12px] justify-center items-center font-archivo font-medium text-[24px] leading-[120%] tracking-[-1px] text-center
            ...
            <a
              className="I-Dv flex flex-row  max-w-[217.14px] h-[57px] rounded-[12px] justify-center items-center py-[14px] px-[24px] font-archivo font-medium text-[24px] leading-[120%] tracking-[-1px] text-[#525252] text-center
                     max-[1440px]:max-w-[180px] max-[1440px]:h-[57px]
                     max-[744px]:text-[20px]"
              href="#"
            >
            ...
            <a
              className="I-Db flex flex-row  max-w-[217.14px] h-[57px] rounded-[12px] justify-center items-center py-[14px] px-[24px] font-archivo font-medium text-[24px] leading-[120%] tracking-[-1px] text-[#525252] text-center
                    max-[1440px]:max-w-[180px] max-[1440px]:h-[57px]
                    max-[744px]:text-[20px]"
              href="#"
            >
            ...
            <a
              className="I-Dy flex flex-row  max-w-[217.14px] h-[57px] rounded-[12px] justify-center items-center py-[14px] px-[24px] font-archivo font-medium text-[24px] leading-[120%] tracking-[-1px] text-[#525252] text-center
                    max-[1440px]:max-w-[180px] max-[1440px]:h-[57px]
                    max-[744px]:text-[20px]"
              href="#"
            >
            ...
            <a
              className="I-Dc flex flex-row  max-w-[217.14px] h-[57px] rounded-[12px] justify-center items-center py-[14px] px-[24px] font-archivo font-medium text-[24px] leading-[120%] tracking-[-1px] text-[#525252] text-center
                    max-[1440px]:max-w-[180px] max-[1440px]:h-[57px]
                    max-[744px]:text-[20px] max-[744px]:w-[105px]"
              href="#"
            >
              Extend
            </a>
            ...
            <a
              className="I-Dl flex flex-row  max-w-[217.14px] h-[57px] rounded-[12px] justify-center items-center py-[14px] px-[24px] font-archivo font-medium text-[24px] leading-[120%] tracking-[-1px] text-[#525252] text-center
                    max-[1440px]:max-w-[180px] max-[1440px]:h-[57px]
                    max-[744px]:text-[20px]"
              href="#"
            >
            ...
            <a
              className="I-De flex flex-row  max-w-[217.14px] h-[57px] rounded-[12px] justify-center items-center py-[14px] px-[24px] font-archivo font-medium text-[24px] leading-[120%] tracking-[-1px] text-[#525252] text-center
                    max-[1440px]:max-w-[180px] max-[1440px]:h-[57px]
                    max-[744px]:text-[20px]"
              href="#"
            >
                ...
                >
                  ...
                  <p
                    className="ipTag-1-1 list-item opacity-100 font-archivo font-normal text-[16px] leading-[150%] tracking-[0px] text-[#171717]
                               "
                  >
                    VCL library improved for use of Microsoft’s WebView 2
                    control in both TEdgeBrowser and TWebBrowser components,
                    with better support for UserDataFolder and ExecutableFolder
                    configurations.
                  </p>
                  ...
                  <p
                    className="ipTag-1-1 list-item  opacity-100 font-archivo font-normal text-[16px] leading-[150%] tracking-[0px] text-[#171717]
                                "
                  >
                    Use VCL Styles at design time! Prototype stylish UIs even
                  ...
                  <p
                    className="ipTag-1-1 list-item  opacity-100 font-archivo font-normal text-[16px] leading-[150%] tracking-[0px] text-[#171717]
                                "
                  >
                    FireMonkey design-time guidelines: Prototype faster with
                    visual lines and enhanced margin and padding support.
                  </p>
