               ...
               max-[375px]:flex-col max-[375px]:m-[0px] max-[375px]:p-[16px] max-[375px]:gap-[4px]">
                ...
                <div className="flex items-center space-x-6 max-[375px]:mr-[14px]">
                    ...
                    <div className="flex items-center space-x-4 text-lg ">
                        <FaSearch className="cursor-pointer hover:text-gray-300 max-[375px]:max-w-[20px] 
                        max-[375px]:h-[20px]" />
                        <FaShoppingCart className="cursor-pointer hover:text-gray-300 max-[375px]:max-w-[20px] 
                        max-[375px]:h-[20px]" />
                        <FaGlobe className="cursor-pointer hover:text-gray-300 max-[375px]:max-w-[20px] 
                        max-[375px]:h-[20px]" />
                    </div>
                </div>
