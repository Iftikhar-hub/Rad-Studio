...
const JoinOurCoummunity = () => {
    return (
        ...
        max-[744px]:w-[744px] max-[744px]:mt-[280px] max-[744px]:flex-col
        max-[375px]:max-w-[375px] max-[375px]:w-full max-[375px]:h-auto max-[375px]:mt-[80px]">
            ...
            <div className="JOC_content flex flex-col w-[633px] h-[280px] gap-[32px]
             ...
             max-[744px]:w-[695px] max-[744px]:items-center max-[744px]:h-[114px]
             max-[375px]:w-[343px] max-[375px]:h-auto max-[375px]:gap-[32px] max-[375px]:top-[48px] max-[375px]:left-[16px]">

                <div className="JOC_c1 flex flex-col w-[100%] h-[196px] gap-[8px]
                   max-[1440px]:gap-[8px] max-[744px]:text-center max-[375px]:mt-[-100px]
                   max-[375px]:h-auto" >

                    <div className="TwoPs max-[744px]:flex max-[744px]:justify-center max-[744px]:items-center max-[744px]:gap-[8px]
                    max-[375px]:block">
                       ...
                       max-[744px]:text-[36px] max-[375px]:text-[27px]">
                ...
                max-[744px]:mt-[auto]
                max-[375px]:w-[343px] max-[375px]:h-auto max-[375px]:flex-col">
                    ...
                    max-[1440px]:w-[122px] max-[1440px]:h-[48px]
                    max-[375px]:w-[343px]" type="button">Subscribe</button>
            ...
            max-[744px]:w-[695px] max-[744px]:mt-[120px]
            max-[375px]:max-w-[343px] max-[375px]:w-full max-[375px]:h-[209px] max-[375px]:mt-[0px]">
                <img className="jm w-[100%] h-[410px] max-[744px]:h-[365px] max-[375px]:h-[160px]" src={GlobalUsers} alt="GlobalUsers" />
