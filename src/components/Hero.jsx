              ...
              max-[375px]:w-[343px]">
                ...
                <div className="bg-black absolute top-[0] w-full max-w-[100%] h-[100%] rounded-[16px] flex  
                 ...
                 max-[744px]:w-[695px] max-[744px]:h-[389px] max-[744px]:top-[0px] max-[744px]:left-[0px] max-[375px]:w-[343px]  max-[375px]:h-[192px] ">
                    ...
                    max-[375px]:w-[23px] max-[375px]:h-[23px]" />
                ...
                <div className="heroLower w-[100%] h-[107px] rounded-[16px] border py-[24px] px-[32px]   
                    ...
                    max-[1440px]:w-[1279px]
                    max-[744px]:w-[695px] max-[744px]:h-[107px] max-[744px]:gap-[32px]
                    max-[375px]:w-[343px] max-[375px]:h-[222px] max-[375px]:flex-col">

                    <div className="logoLN flex flex-row justify-center items-center w-[1011px] h-[59px] gap-4
                    max-[744px]:w-[432px] max-[744px]:h-[59px] max-[744px]:gap-[16px]
                    ...
                    <div class="flex flex-row w-[167px] h-[43px] rounded-[12px] justify-center items-center bg-[#262626] max-[375px]:w-[311px]">
